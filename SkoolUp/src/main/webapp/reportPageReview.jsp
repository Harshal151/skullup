...
<style>
 ...
 <script type="text/javascript">
      ...
      function windowOpen1(){
         document.location="RenderReportCardReview";
      }
    ...
    <div class="content-container" style="z-index: 0;">
      ...
      <div class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="RenderReportCardReview">Student Details</a></li>
      ...
      <div class="row">
		...
		<form id="validate-basic" action="StudentReportReviewPDF" method="POST" data-validate="parsley" class="form parsley-form">
