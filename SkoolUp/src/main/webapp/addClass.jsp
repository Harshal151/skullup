...
<html class="no-js"> 
<head>
  <title>Register Class - SkoolUp</title>
<!-- Favicon -->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<table border="1">
					...
					<tr id="divisionTRID">
						<td><input type="text" id="divisionID" name="division"></td>
  ...
  <div class="content">
    ...
    <div class="content-container" style="z-index: 0;">
      ...
      <div class="content-header">
        <h2 class="content-header-title">Register Class</h2>
        <ol class="breadcrumb">
			  ...
			  <div class="row">    
	            <div class="col-md-12">
	            	<form action="AddClass" method="POST">
	            		...
	            		<tr id="standardTRID">
	            			<td>
	            				<input type="text" name="standard" placeholder="Standard Name" id="standardNameID">
	            			</td>
	            			<td>
	            				<div class="form-group">
									<select id="SubjectID"  class="form-control" multiple>
					                	<option value="-1">Select Subject</option>
					                	<%
						         			for(String subjectFormName:subjectList){
						         		%>
						         		<option value="<%=subjectFormName%>"><%=subjectFormName%></option>
